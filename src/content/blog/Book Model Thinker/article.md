...
#### 对数正态分布
![[Pasted image 20250914113609.png]]
...
#### 幂律分布和肥尾分布
![[Pasted image 20250914113630.png]]
幂律分布是有明确的公式的：
$$p(x) =  Cx^{-\alpha}$$
如果不满足这个公式，可能是肥尾分布但不是幂律分布。从这个公式中，我们可以得出幂律分布在双对数坐标系下是一条直线。
![[Pasted image 20250914114435.png]]
%%上面这个图就是放着玩的，看不懂就别看了%%
...
> 这篇文章是我创建博客以来，花时间最多的一篇。不仅是写的时间长（10h左右），看书本身也花了至少20h+。但当我看到AI几秒钟就帮我补全了后两章，质量看起来也还行，属实有点没绷住。。。。。唉。